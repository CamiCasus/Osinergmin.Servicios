...
namespace Domain.MainModule.Entities
{
    public class InformeEnsayoLiquidoEntity : InformeEnsayoEntity
    {
        ...
        public string contenidoMtbeVolumen { get; set; }
        public string contenidoTameVolumen { get; set; }
        public string contenidoEtbeVolumen { get; set; }
        public string contenidoMetanolVolumen { get; set; }
        public string contenidoTertbutanoVolumen { get; set; }
        public string contenidoDipeVolumen { get; set; }
        public string contenidoMtbeMasa { get; set; }
        public string contenidoTameMasa { get; set; }
        public string contenidoEtbeMasa { get; set; }
        public string contenidoEtanolMasa { get; set; }
        public string contenidoMetanolMasa { get; set; }
        ...
        public string remanenteRetirado { get; set; }
    }
}
